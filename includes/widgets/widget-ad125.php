...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: Themes4all 125x125 Ad Widget
...
// load widget
add_action( 'widgets_init', 'themes4all_ads_widgets' );

// Register widget
function themes4all_ads_widgets() {
	register_widget( 'themes4all_Ad_Widget' );
}

// Widget class
class themes4all_ad_widget extends WP_Widget {
...
function themes4all_Ad_Widget() {

	// Widget settings
	$widget_ops = array (
		'classname' => 'themes4all_ad_widget',
		'description' => __('A widget for 125 x 125 ad unit (maximum 6 ads)', 'simple')
	);
	...
	$control_ops = array (
		'width' => 300,
		'height' => 350,
		'id_base' => 'themes4all_ad_widget'
	);

	// Create the widget
	$this->WP_Widget( 'themes4all_ad_widget', __('Themes4all: 125x125 Ads', 'simple'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_template_directory_uri().'/images/common/ad125.png',
		'link1' => '',
		'ad2' => get_template_directory_uri().'/images/common/ad125.png',
		'link2' => '',
		'ad3' => get_template_directory_uri().'/images/common/ad125.png',
		'link3' => '',
		'ad4' => get_template_directory_uri().'/images/common/ad125.png',
		'link4' => '',
		'ad5' => get_template_directory_uri().'/images/common/ad125.png',
		'link5' => '',
		'ad6' => get_template_directory_uri().'/images/common/ad125.png',
		'link6' => '',
		'random' => false
	);
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Ad 5 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Ad 5 link url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Ad 6 image url:', 'simple') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Ad 6 link url:', 'simple') ?></label>
	...
	<!-- Randomize? -->
	<p>
		<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('Randomize ads order?', 'simple') ?></label>
