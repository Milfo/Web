      ...
      <?php } ?>
				...
				<div id="post-0" <?php post_class() ?>>
					...
					<div class="content-404">
						<?php _e('The page you are looking for does not exist; it may have been moved, or removed altogether. You might want to try the search function. Alternatively, return to the <a href="/">front page</a>.') ?>
					</div>
          </div>
          </div>
